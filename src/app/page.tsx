      ...
      <footer className="bg-[#0f1f63] text-white">
        <div className="mx-auto w-full max-w-[1400px] px-6 py-10 sm:px-8 lg:px-12">
          <div className="grid gap-10 border-b border-white/20 pb-10 lg:grid-cols-[1.1fr_1.1fr_1.1fr_1.9fr]">
            ...
            <div>
              <h3 className="mb-4 text-3xl font-black uppercase leading-none">
                Abonnez-vous et obtenez -10%
              </h3>
              <p className="mb-4 max-w-xl text-sm text-white/80">
                Recevez les dernieres nouveautes, nos offres exclusives et les
                infos sur les nouveaux drops Vero7.
              </p>
          ...
          <div className="pt-6 text-xs text-white/55">
            Copyright Â© {new Date().getFullYear()} Vero7 - Tous droits reserves
          </div>
        </div>
      </footer>
    </div>
