      ...
      <div className="hidden sm:block rounded-lg border border-zinc-200 bg-white">
        <table className="w-full table-fixed text-left text-sm">
          <thead className="bg-zinc-50 border-b border-zinc-200">
            <tr>
              <th className="w-[26%] px-2 py-2 text-left text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs">
                Product
              </th>
              <th className="w-[12%] px-2 py-2 text-left text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs">
                Price
              </th>
              <th className="w-[6%] px-2 py-2 text-left text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs hidden sm:table-cell">
                Stock
              </th>
              <th className="w-[9%] px-2 py-2 text-left text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs hidden md:table-cell">
                Category
              </th>
              <th className="w-[8%] px-2 py-2 text-left text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs hidden md:table-cell">
                Couleur
              </th>
              <th
                className="w-[7%] px-1 py-2 text-center text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs hidden sm:table-cell"
              ...
              <th className="w-[18%] px-2 py-2 text-right text-[11px] font-semibold uppercase tracking-wide text-zinc-600 sm:text-xs">
                Actions
              </th>
            </tr>
          </thead>
            ...
            {products.length === 0 ? (
              ...
              products.map((p) => (
                <tr key={p.id} className="border-b border-zinc-100 hover:bg-zinc-50/50">
                  ...
                  <td className="px-2 py-2 text-black text-xs sm:text-sm">
                    {p.discount_price != null ? (
                      <span className="block truncate" title={`${p.price} DT → ${p.discount_price} DT`}>
                        <span className="line-through text-zinc-400">{p.price}</span>{" "}
                        <span className="font-medium">{p.discount_price} DT</span>
                      </span>
                    ) : (
                  ...
                  <td className="px-2 py-2 text-zinc-700 hidden md:table-cell">
                    <span className="block truncate" title={formatColorPair(p, colors)}>
